...
```
action = ActionChains(self.browser)action.click_and_hold(getcache).perform()action.move_to_element_with_offset(to_element=getcache,xoffset=288, yoffset=0).perform()
```
